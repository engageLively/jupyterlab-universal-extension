...
```bash
pip install jupyterlab_universal_extension
```
...
```bash
pip uninstall jupyterlab_universal_extension
```
...
# Change directory to the jupyterlab_universal_extension directory
...
folder is located. Then you can remove the symlink named `jupyterlab-universal-extension` within that folder.
